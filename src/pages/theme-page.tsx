...
export const ThemePage: FC = () => {
  ...
  return (
    <div>
      <Switch id="themeSwitch" variant="secondary" label={`Theme: ${theme}`} checked={theme === 'dark'} onClick={() => toggleTheme()} />
      <div className="grid grid-cols-4 gap-10 p-10">
        <div className="space-y-5">
          <h2 className="text-center">Buttons / Links</h2>
          <div className="flex flex-row justify-between">
            <Button variant="primary" componentSize="sm">Primary</Button>
            <Link to="/" variant="primary" componentSize="sm">Primary</Link>
          ...
          <div className="flex flex-row justify-between">
            ...
            <Link to="/" variant="primary" componentSize="md">Primary</Link>
          ...
          <div className="flex flex-row justify-between">
            ...
            <Link to="/" variant="primary" componentSize="lg">Primary</Link>
